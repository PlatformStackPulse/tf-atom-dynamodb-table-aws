# tf-atom-dynamodb-table-aws

[![CI](https://github.com/PlatformStackPulse/tf-atom-dynamodb-table-aws/actions/workflows/ci.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-dynamodb-table-aws/actions/workflows/ci.yml)
![Terraform](https://img.shields.io/badge/terraform-%3E%3D1.6.0-blueviolet)

## Purpose

Single DynamoDB table with configurable billing, hash/range keys, and optional GSIs/LSIs.
...
| <a name="input_hash_key"></a> [hash\_key](#input\_hash\_key) | Hash key attribute name | `string` | n/a | yes |
...
| <a name="input_global_secondary_indexes"></a> [global\_secondary\_indexes](#input\_global\_secondary\_indexes) | List of GSI configurations | `list(any)` | `[]` | no |
...
| <a name="input_kms_key_arn"></a> [kms\_key\_arn](#input\_kms\_key\_arn) | KMS key ARN for encryption (null uses AWS managed key) | `string` | `null` | no |
...
| <a name="input_local_secondary_indexes"></a> [local\_secondary\_indexes](#input\_local\_secondary\_indexes) | List of LSI configurations | `list(any)` | `[]` | no |
...
| <a name="input_range_key"></a> [range\_key](#input\_range\_key) | Range key attribute name (optional) | `string` | `null` | no |
| <a name="input_read_capacity"></a> [read\_capacity](#input\_read\_capacity) | Read capacity units (only for PROVISIONED) | `number` | `5` | no |
...
| <a name="input_ttl_attribute_name"></a> [ttl\_attribute\_name](#input\_ttl\_attribute\_name) | TTL attribute name | `string` | `""` | no |
| <a name="input_ttl_enabled"></a> [ttl\_enabled](#input\_ttl\_enabled) | Enable TTL | `bool` | `false` | no |
| <a name="input_write_capacity"></a> [write\_capacity](#input\_write\_capacity) | Write capacity units (only for PROVISIONED) | `number` | `5` | no |
...
| <a name="output_stream_arn"></a> [stream\_arn](#output\_stream\_arn) | ARN of the DynamoDB table stream |
<!-- END_TF_DOCS -->
